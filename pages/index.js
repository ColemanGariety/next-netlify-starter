...
export default function Home() {
  return (
    <div className="container">
      ...
      <p>For example, look at the lyrics of The Beatles 'Strawbeery Fields Forever': "Nothing is real, it doesn't matter much to me, take me down to that endless red place la la la la." This is nihilism: it says, "hell isn't so bad, come try it out!" It's pure evil.</p>
